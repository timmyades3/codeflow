  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
          {plans.map((plan, key) => (
            <div
              key={key}
            ...
            >
              ...
              <div className="text-center mb-6 sm:mb-8 ">
                ...
                <div className="flex items-baseline justify-center ">
                  <span className="text-3xl sm:text-4xl lg:text-5xl font-bold  bg-linear-to-b from-blue-500 to-cyan-500 text-transparent bg-clip-text  ">
                    $ {plan.price}
                  </span>
                  <span className="gray-400 ml-1 sm:m-2 text-sm sm:text-base">
                    /month
                  </span>
                </div>
              </div>
              <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 flex-row">
                {plan.features.map((feature, featureKey) => (
                  ...
                  >
                    <div className="shrink-0 w-4 h-4 sm:h5 sm:w-5 rounded-full bg-blue-500/20 flex items-center justify-center mt-0.5 ">
              ...
              <button
                className={`w-full px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold transition-all duration-300 mt-auto hover:scale-102 cursor-pointer text-sm sm:text-base 
                  ${
                    plan.mostPopular
