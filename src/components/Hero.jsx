      ...
      <div className="max-w-7xl mx-auto text-center realtive w-full">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center relative">
          <div className="">
            ...
            <h1 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold">
              <span className="">
                Code Faster
              </span>
              <span className="">
          ...
          <div className="relative order-2 w-full">
            <div className="relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10">
              <div className="bg-linear-to-br from-gray-900/20 to-gray-800/20  backdrop-blur-sm rounded-lg overflow-hidden h-70 sm:w-[360] lg:h-112.5 border border-white/5">
                {/* IDE HEADER */}
